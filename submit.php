...
$sql = "INSERT INTO datas (name, phone, email, subject, message) VALUES ('$name','$phone','$email','$subject','$message')";
if($conn->query($sql)){
...
<body>
    <div class="thank-you-message">
        <img src="img/mercedes-benz-logo-png-11323.png" alt="Mercedes-Benz Logo">
        <h1 class="cursive">Thank You!</h1>
        <p>Your submission has been received. We appreciate your interest in Mercedes-Benz.</p>
